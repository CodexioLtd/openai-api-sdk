...
import static bg.codexio.ai.openai.api.sdk.chat.Chat.*;
...
public class ChatTest {
    private ChatHttpExecutor CHAT_EXECUTOR = mock(ChatHttpExecutor.class);

    @Test
    public void testThroughHttp_expectExecutor() {
        var nextStage = throughHttp(CHAT_EXECUTOR);
