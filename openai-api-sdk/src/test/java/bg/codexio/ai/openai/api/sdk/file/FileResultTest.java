...
public class FileResultTest {
    ...
    //
    //    @Test
    //    void testDownload_withAuth_expectCorrectResponse() throws
    //    IOException {
    //        try (
    //                var downloadUtils = mockStatic(DownloadExecutor.class);
    //                var mockedFile = mockStatic(Files.class)
    ...
    //                    FILE,
    //                    FromDeveloper.doPass(new ApiCredentials
    //                    (API_CREDENTIALS))
    //            );
    //            this.assertDownloadedFile(result);
    //        }
    ...
    //    @Test
    //    void
    //    testDownload_withRetrieveFileContentHttpExecutor_expectCorrectResponse()
    //            throws IOException {
    //        try (
    //                var downloadUtils = mockStatic(DownloadExecutor.class);
    //                var mockedFile = mockStatic(Files.class)
    ...
    //    }
    //
    //    private void downloadMockedExecution(MockedStatic<DownloadExecutor>
    //    downloadUtils) {
