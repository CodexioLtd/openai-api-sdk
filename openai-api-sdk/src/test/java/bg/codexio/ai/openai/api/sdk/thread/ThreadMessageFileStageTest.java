...
public class ThreadMessageFileStageTest {
    ...
    //        var response = this.threadMessageFileStage.feed
    //        (FILE_IDS_VAR_ARGS);
    //
    ...
    //    @Test
    //    void
    //    testFeed_withFileIdVarArgsAndEmptyContent_expectCorrectResponse() {
    //        this.initializeStageWithEmptyContent();
    //        execute(this.threadMessageFileStage);
    //        var response = this.threadMessageFileStage.feed
    //        (FILE_IDS_VAR_ARGS);
    ...
    //        var auth =
    //                Files.authenticate(FromDeveloper.doPass(new
    //                ApiCredentials(API_CREDENTIALS)));
    //        try (
    //                var authUtils = mockStatic(Authenticator.class);
    //                var filesSimplified = mockStatic(FileUploadSimplified
    //                .class)
    //        ) {
    ...
    //        execute(this.threadMessageFileStage);
    //        var response = this.threadMessageFileStage.attach
    //        (FILE_IDS_VAR_ARGS);
    //
    //        assertNotNull(response);
    //    }
    //
    //    private void performFeedWithFile(ThreadConfigurationStage
    ...
    //    }
    //
    //    private void performFeedWithFileResponse(ThreadConfigurationStage
    //    threadConfigurationStage) {
    //        execute(threadConfigurationStage);
