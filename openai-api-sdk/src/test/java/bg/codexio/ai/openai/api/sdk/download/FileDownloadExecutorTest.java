...
class FileDownloadExecutorTest {
    ...
    private FileDownloadExecutor fileDownloadExecutor;
    ...
    void setUp() {
        ...
        this.fileDownloadExecutor = new FileDownloadExecutor(
    ...
    public void testDownloadTo_expectCorrectFileNameAndTargetFolderCreation(
        ...
        mockFileDownloading(
                ...
                FILE_URL.concat("random-test-uuid".concat(FILE_TEST_NAME))
        );
    }
}