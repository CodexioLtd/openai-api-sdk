...
public class TranscriptionHttpExecutorTest {
    ...
    private static final TranscriptionRequest REQUEST_DTO =
            TranscriptionRequest.builder()
                                                                                .withFile(new File(TranscriptionHttpExecutorTest.class.getClassLoader()
    ...
    private TranscriptionHttpExecutor executor;
