...
public class ImageVariationHttpExecutorTest {

    private static final String URL = TEST_BASE_URL.concat("/images/variations");
    private static final String MULTIPART_NO_STREAM_REQUEST =
            "--test-boundary\n"
                    ...
                    + "test-user\n" + "--test-boundary--";
    private static final ImageVariationRequest REQUEST_DTO =
            new ImageVariationRequest(
            new File(ImageVariationHttpExecutorTest.class.getClassLoader()
    ...
    private ImageVariationHttpExecutor executor;
    ...
    private void initExecutor() {
        this.executor = new ImageVariationHttpExecutor(
                this.client,
                TEST_BASE_URL,
                new ObjectMapper()
        );
